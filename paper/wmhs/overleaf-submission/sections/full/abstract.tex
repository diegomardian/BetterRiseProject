...
total error. A clean control separates equality from interval performance: the same point
estimate has approximately 95\% coverage with its usual interval and 36\% with
a deliberately narrowed one. Controlled count-grid experiments retain the
calibration failure, while separate patient-omission checks reveal sensitivity
to cohort composition. The audit clarifies what a
recovery curve measures and why interval coverage and abstention rules require
separate evaluation.
\end{abstract}

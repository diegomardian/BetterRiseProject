...
against depth and flags anything above $|\rho| = 0.20$. For Spearman correlation with untied depth ranks and a \emph{binary} label
of prevalence $p$, $\sqrt{3p(1-p)}$ is the large-sample ceiling used by our
diagnostic, not a universal Pearson-correlation bound. Below $p = 1.3516\%$
the 0.20 tolerance exceeds this approximate ceiling. Tied depth values require
a tie-aware bound; the reported ceilings below use the untied approximation. Our rarest rung

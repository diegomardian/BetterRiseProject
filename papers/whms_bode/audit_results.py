...
def main():
    ...
    out={
      ...
      'patient_target_followup':json.loads((PAPER/'diagnostics/patient_target_provenance.json').read_text()),
      ...
      'verification':{'dedicated_result_tests':51,'retained_control_harness_tests':21,'external_control_harness_tests':35,'historical_original_manuscript_result_tests':55,'learned_table_numeric_entries':30},
    }

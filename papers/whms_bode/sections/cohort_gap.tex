...
For the implemented binomial thinning, the tumour-cell variance is
...
\end{equation}
With $n_T=50$ and $n_N=800$, the median signal-to-standard-deviation ratios
are 3.02 in SMC and 1.53 in KUL3. This provides a distributional explanation
for weaker KUL3 discrimination. It does not reproduce the exact 70-versus-400
candidate ratio: percentile-bootstrap behavior, pair heterogeneity and binning

\subsection{Welch as a control for bootstrap resampling noise}
...
Section~\ref{sec:repair} separately compares bootstrap budgets and
skew-aware methods.
...
\caption{Detection must be read alongside null rejection. All four cohort/pool conditions use 5{,}000 studies per point; bars are 95\% Wilson Monte Carlo
